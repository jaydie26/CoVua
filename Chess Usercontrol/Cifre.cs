    ...
    public class CCifre
    {
        ...
        void deseneaza_cifra(int n, Rectangle rect, Graphics pdc)
        {
            ...
            switch (n)
            {
                case 8:
                    {
                        hor_line(new Rectangle(x + grosime / 2 + 2, y, x1 - grosime / 2 - 2, y + grosime), pdc, true);
                        ver_line(new Rectangle(x, y + grosime / 2, x + grosime, y + inaltime), pdc, true);
                        ver_line(new Rectangle(x, y1 - inaltime, x + grosime, y1 - grosime / 2), pdc, true);
                        hor_line(new Rectangle(x + grosime / 2 + 2, y1 - grosime, x1 - grosime / 2 - 2, y1), pdc, true);
                        ver_line(new Rectangle(x1 - grosime, y + inaltime, x1, y1 - grosime / 2), pdc, true);
                        ver_line(new Rectangle(x1 - grosime, y + grosime / 2, x1, y + inaltime), pdc, true);
                ...
                case 1:
                    {
                        hor_line(new Rectangle(x + grosime / 2 + 2, y, x1 - grosime / 2 - 2, y + grosime), pdc, false);
                      
                        ver_line(new Rectangle(x, y + grosime / 2, x + grosime, y + inaltime), pdc, false);
                        ver_line(new Rectangle(x, y1 - inaltime, x + grosime, y1 - grosime / 2), pdc, false);//
                        hor_line(new Rectangle(x + grosime / 2 + 2, y1 - grosime, x1 - grosime / 2 - 2, y1), pdc, false);
                        ver_line(new Rectangle(x1 - grosime, y + inaltime, x1, y1 - grosime / 2), pdc, true);
                        ver_line(new Rectangle(x1 - grosime, y + grosime / 2, x1, y + inaltime), pdc, true);
                        hor_line(new Rectangle(x + grosime / 2 + 2, y + inaltime - grosime / 2, x1 - grosime / 2 - 2, y + inaltime + grosime / 2), pdc, false);//mijloc
                        break;
                ...
                case 2:
                    {
                        ...
                        ver_line(new Rectangle(x, y1 - inaltime, x + grosime, y1 - grosime / 2), pdc, true);
                        hor_line(new Rectangle(x + grosime / 2 + 2, y1 - grosime, x1 - grosime / 2 - 2, y1), pdc, true);
                        ver_line(new Rectangle(x1 - grosime, y + inaltime, x1, y1 - grosime / 2), pdc, false);
                        ver_line(new Rectangle(x1 - grosime, y + grosime / 2, x1, y + inaltime), pdc, true);
                        hor_line(new Rectangle(x + grosime / 2 + 2, y + inaltime - grosime / 2, x1 - grosime / 2 - 2, y + inaltime + grosime / 2), pdc, true);//mijloc
                        break;
                    }
